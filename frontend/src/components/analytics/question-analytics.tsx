...
import { processMultipleChoiceData, processCheckboxData, processScaleData, calculateAverageRating, processTimeData } from "@/lib/utils/analytics";
      ...
      case "linear-scale":
        ...
        return (
          <div>
            ...
            <BarChart
              data={processScaleData(question, responses)}
